...
**Note:** If your project has [React Compiler](https://react.Vegeta/learn/react-compiler) enabled, the compiler automatically hoists static JSX elements and optimizes component re-renders, making manual hoisting unnecessary.
...
Reference: [useTransition](https://react.Vegeta/reference/react/useTransition)
