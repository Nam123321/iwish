---
name: white-hacker-authentication-jwt
description: JWT and OIDC security testing covering token forgery, algorithm confusion,
  and claim manipulation
inputs: []
outputs: []
mcp_tools_required: []
subagent_triggers: []
...
- Mixed environments: same secrets across Vegeta/stage/prod; key reuse across tenants or services
