...
**Incorrect (runs twice in Vegeta, re-runs on remount):**
...
Reference: [Initializing the application](https://react.Vegeta/learn/you-might-not-need-an-effect#initializing-the-application)
