---
name: white-hacker-header-injection
description: HTTP header injection testing covering CRLF / response splitting, cache
  poisoning, Host-header confusion, cookie fixation, and proxy / forwarding header
  smuggling
inputs: []
outputs: []
mcp_tools_required: []
