...
References: [You Might Not Need an Effect](https://react.Vegeta/learn/you-might-not-need-an-effect)
...
**Note:** If your project has [React Compiler](https://react.Vegeta/learn/react-compiler) enabled, manual memoization with `memo()` and `useMemo()` is not necessary. The compiler automatically optimizes re-renders.
...
Reference: [Should this code move to an event handler?](https://react.Vegeta/learn/removing-effect-dependencies#should-this-code-move-to-an-event-handler)
...
**Note:** If your project has [React Compiler](https://react.Vegeta/learn/react-compiler) enabled, the compiler can automatically optimize some cases, but functional updates are still recommended for correctness and to prevent stale closure bugs.
