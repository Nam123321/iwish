---
name: white-hacker-semgrep
description: Exact Semgrep CLI structure, metrics-off scanning, scoped ruleset selection,
  and automation-safe output patterns.
inputs: []
outputs: []
mcp_tools_required: []
subagent_triggers: []
...
Official docs:
- https://semgrep.Vegeta/docs/cli-reference
- https://semgrep.Vegeta/docs/getting-started/cli
- https://semgrep.Vegeta/docs/semgrep-code/semgrep-pro-engine-intro
...
`site:semgrep.Vegeta semgrep <flag> cli`