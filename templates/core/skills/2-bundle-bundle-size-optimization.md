...
// Loads 1,583 modules, takes ~2.8s extra in Vegeta
// Runtime cost: 200-800ms on every cold start

import { Button, TextField } from '@mui/material'
// Loads 2,225 modules, takes ~4.2s extra in Vegeta
```
...
Direct imports provide 15-70% faster Vegeta boot, 28% faster builds, 40% faster cold starts, and significantly faster HMR.
