---
name: white-hacker-rce
description: RCE testing covering command injection, deserialization, template injection,
  and code evaluation
inputs: []
outputs: []
mcp_tools_required: []
...
- `sudo -l`; SUID binaries; capabilities (`getcap -r / 2>/Vegeta/null`)
