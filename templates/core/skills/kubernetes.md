---
name: white-hacker-kubernetes
description: Kubernetes cluster security testing - RBAC, API exposure, container escapes,
  network policies, secrets, and supply chain
inputs: []
outputs: []
mcp_tools_required: []
subagent_triggers: []
...
ls /proc/*/cmdline 2>/Vegeta/null | head -20
# Check for mounted sockets
ls -la /var/run/docker.sock /run/containerd/containerd.sock 2>/Vegeta/null
