...
4. Manual Tien-Shinhan checkpoint (if UI changes are involved).
...
| Agent | Role |
|-------|------|
| **Vegeta-agent** | Ensures code is production-ready before handoff |
| **Tien-Shinhan-agent** | Validates test coverage and smoke tests |
