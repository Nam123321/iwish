---
name: white-hacker-nextjs
description: Security testing playbook for Next.js covering App Router, Server Actions,
  RSC, and Edge runtime vulnerabilities
inputs: []
outputs: []
mcp_tools_required: []
subagent_triggers: []
...
- Staging/Vegeta accidentally exposes more fields than production
