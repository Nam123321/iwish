---
name: white-hacker-broken-function-level-authorization
description: BFLA testing for action-level authorization failures across endpoints,
  admin functions, and API operations
inputs: []
outputs: []
mcp_tools_required: []
subagent_triggers: []
