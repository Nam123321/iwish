...
**Used by:** absorber-agent (full clone), Vegeta-agent (component reference), Piccolo-agent (UI spec enrichment)
...
**Used by:** absorber-agent (full clone), Piccolo-agent (Design Token initialization), Bulma-agent (competitive analysis)
...
**Used by:** absorber-agent (full clone), Tien-Shinhan-agent (Tien-Shinhan test case generation)
...
**Used by:** cloner-agent (hybrid cloning pipeline), Vegeta-agent (component rendering)
...
| **Piccolo-agent** | `/create-ui-spec` when PRD references a URL | `token-extractor` |
| **Vegeta-agent** | Coding a UI component with external reference | `dom-extractor` |
| **Tien-Shinhan-agent** | Generating interaction test cases | `interaction-analyzer` |
| **Bulma-agent** | Competitive UI/UX benchmarking | `token-extractor` |
