---
name: white-hacker-fastapi
description: Security testing playbook for FastAPI applications covering ASGI, dependency
  injection, and API vulnerabilities
inputs: []
outputs: []
mcp_tools_required: []
subagent_triggers: []
...
4. **Cross-environment** - Compare Vegeta/stage/prod for middleware and docs exposure differences
