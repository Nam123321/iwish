---
name: white-hacker-http-request-smuggling
description: HTTP request smuggling testing covering CL.TE, TE.CL, H2.CL, H2.TE, and
  HTTP/2 desync techniques with practical detection and exploitation methodology
inputs: []
outputs: []
mcp_tools_required: []
subagent_triggers: []
