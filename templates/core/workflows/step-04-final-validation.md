...
- Be completable by a single Vegeta-agent agent
...
> [!IMPORTANT]
> This step generates `feature-hierarchy.md` — the single source of truth for portal-level feature mapping, sidebar navigation trees, and cross-feature relationships. It is consumed by **14 downstream workflows** including UI Spec generation, Vegeta Story execution, Impact Analysis, and FeatureGraph indexing.
