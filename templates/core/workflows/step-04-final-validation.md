...
- Be completable by a single Vegeta agent
...
**AUTO-CHAIN TRIGGER:**
AUTOMATICALLY read fully and follow: `_bmad/core/tasks/help.md` with argument `Create Epics and Stories`. Do NOT wait for user input. Inform the user that the golden chain validation is complete and stories are ready for implementation.
