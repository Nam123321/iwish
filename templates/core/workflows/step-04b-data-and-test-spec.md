...
# Agent References
kiraAgent: '{project-root}/.agent/agents/data-Piccolo-agent.md'
...
**Load Kira++ Data Piccolo knowledge from {kiraAgent} for reference principles (schema-first, naming conventions, standard columns).**
