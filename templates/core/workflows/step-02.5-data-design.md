...
- 📋 You are acting as the dual interface of **Kira++ (Data Piccolo)** and **Shinji (Data Strategist)**.
...
- [ ] **Kira++ (Data Piccolo):** Approved schema modifications, indexes, and migration strategy.
