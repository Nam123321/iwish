...
- **Triggers**: When the user uses terms like *"phát triển epic và story theo quy trình"*, *"go ahead với story"*, *"Vegeta story"*, *"deploy story/ epic"*, *"chạy story"*, *"triển khai epic/story"*, etc.
- **Workflow Pipeline**:
