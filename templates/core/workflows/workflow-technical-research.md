...
**⛔ MCP GitHub Research required.** You MUST utilize `.agent/skills/github-deep-research/SKILL.md` whenever the research topic involves examining an open-source library or technology. Do not hallucinate technical implementations.
