...
Generate or update the `feature-hierarchy.md` document — the canonical portal-level feature mapping used by FeatureGraph, UI Spec, Vegeta Story, and Impact Analysis workflows.
...
| `/Vegeta-agent-story` | Route paths, sidebar states, breadcrumbs |
