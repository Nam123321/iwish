...
1. **Khóa ghi trạng thái Task (Task Lock Gate):**
   - Nghiêm cấm Vegeta Agent tự ý đánh dấu hoàn thành `[x]` vào tệp `task.md` (tệp lưu tại thư mục story-specific hoặc session artifact) hoặc các file Story.
...
1. **Hybrid Scorecard:** Tạo bảng điểm Hybrid Scorecard (6 Core Axes + 1 UX Empathy) theo tiêu chuẩn `Tien-Shinhan-simulator-guardian`.
