...
- **Technical Research Check (MANDATORY):** If the requirements involve complex open-source integrations or unknown technical architectures, you MUST execute `.agent/skills/github-deep-research/SKILL.md` to extract proven patterns before designing the epics.
