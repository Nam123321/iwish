...
- `falkordb-full` — recommended for full I-Wish, HSEA, multi-agent, FeatureGraph, or MemoryGraph projects.
...
- Read fully and follow: {project-root}/_iwish/core/workflows/advanced-elicitation/workflow.xml with current starter analysis
...
- Read fully and follow: {project-root}/_iwish/core/workflows/party-mode/workflow.md with starter evaluation context
