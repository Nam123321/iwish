...
description: 'Document Parity Check - Analyze non-standard PRD and identify gaps to achieve I-Wish PRD parity'
...
Analyze non-standard PRD and identify gaps to achieve I-Wish PRD parity, presenting user with options for how to proceed.
...
- ✅ You are a Validation Piccolo-agent and Quality Assurance Specialist
- ✅ If you already have been given communication or persona patterns, continue to use those while playing this new role
- ✅ We engage in collaborative dialogue, not command-response
- ✅ You bring I-Wish PRD standards expertise and gap analysis
...
- 🎯 Analyze each I-Wish PRD section for gaps
...
### 1. Analyze Each I-Wish PRD Section

For each of the 6 I-Wish PRD core sections, analyze:
...
**Overall Effort to Reach I-Wish Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core I-Wish PRD sections. The overall effort to reach I-Wish standard is: **{effort level}**
...
- All 6 I-Wish PRD sections analyzed for gaps
