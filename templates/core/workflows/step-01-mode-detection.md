...
- User provided a path to a tech-spec file (e.g., `quick-Vegeta-agent tech-spec-auth.md`)
...
- IF P: Direct user to `{quick_spec_workflow}`. **EXIT Quick Vegeta-agent.**
...
**[W] Seems bigger than quick-Vegeta-agent** - Recommend the Full BMad Flow PRD Process
**[E] Execute directly**

#### Menu Handling Logic:

- IF P: Direct to `{quick_spec_workflow}`. **EXIT Quick Vegeta-agent.**
- IF W: Direct user to run the PRD workflow instead. **EXIT Quick Vegeta-agent.**
...
- Escalation ([P] or [W]): "**EXITING Quick Vegeta-agent.** Follow the directed workflow."
