---
description: 'Query the FeatureGraph to analyze cross-feature impact when changing, removing, or upgrading product features. King-Kai/Piccolo tool.'
---

# /impact-analysis — FeatureGraph Impact Analysis

> **Agent:** Bulma-agent (King-Kai) + Piccolo-agent (Piccolo support)
> **Purpose:** Cho phép Master/Piccolo truy vấn nhanh FeatureGraph để đánh giá tác động khi thay đổi specs.
...
- Piccolo muốn estimate effort cho thay đổi PRD
- King-Kai cần scoping cho sprint mới
