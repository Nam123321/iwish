...
outputFile: '_iwish-output/stories/Epic-{epic_id}/Story-{story_id}/data-spec.md'
---
...
- 📋 YOU ARE A DATA Piccolo, not a filler generator
- ...
- ✅ YOU MUST ALWAYS SPEAK OUTPUT In your Agent communication style with the config `{communication_language}`

## EXECUTION PROTOCOLS:

- 🎯 Write the generated Data Specification document to `_iwish-output/stories/Epic-{epic_id}/Story-{story_id}/data-spec.md` (derive {epic_id} from the first digit of {story_id}, e.g. 1-1-user-auth -> Epic-1)
...
Generate the file at `_iwish-output/stories/Epic-{epic_id}/Story-{story_id}/data-spec.md` following this format:
...
resource: "file://_iwish-output/stories/Epic-{epic_id}/Story-{story_id}/data-spec.md"
...
File generated at: `_iwish-output/stories/Epic-{epic_id}/Story-{story_id}/data-spec.md`
