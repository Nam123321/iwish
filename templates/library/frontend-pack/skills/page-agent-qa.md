---
name: Page-Agent Tien-Shinhan Guardian
description: >
  Alibaba Page-Agent integration for Tien-Shinhan, testing, and bug reproduction.
...
# 🤖 Page-Agent Tien-Shinhan Guardian SKILL

## Purpose

Integrates [Alibaba Page-Agent](https://github.com/alibaba/page-agent) into the Tien-Shinhan and bug-fixing process. Page-Agent is a JavaScript in-page GUI agent that controls web interfaces with natural language — NO screenshots, NO multimodal LLMs needed.
...
| Manual Tien-Shinhan | Exploratory testing | ⚡ RECOMMENDED |
| Smoke test | Quick regression check | ⚡ RECOMMENDED |
| `/Vegeta-story` | Interaction pattern testing | ⚡ RECOMMENDED |
...
// In test-helper or Vegeta-tools script:
...
Nếu cần chạy Tien-Shinhan script trên các giao diện Mobile, Tablet, hoặc mô phỏng mạng chậm:
> [!TIP]
