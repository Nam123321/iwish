...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="EC or fuzzy match on edge, risk, guardian" exec="{project-root}/_bmad/core/agents/edge-case-guardian.md">[EC] Edge Case Guardian</item>
    ...
    <item cmd="DS or fuzzy match on data-strategist, shinji, bi, data-flow, kb-sync" exec="{project-root}/_bmad/bmm/agents/data-strategist.md">[DS] 📊🔬 Shinji (Data Strategist)</item>
