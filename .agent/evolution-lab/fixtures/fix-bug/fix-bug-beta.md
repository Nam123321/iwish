...
> Đối với những bug thuộc Tier 🔴 SBRP-Full (đặc biệt là logic, architecture, security), sau khi có được bản fix từ nội bộ (bmad-native), agent BẮT BUỘC gọi công cụ Evolution Lab để thực hiện kiểm thử A/B.
