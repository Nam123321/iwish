---
name: sdd-cache
description: Cross-session citation cache for source-driven-development. Skips redundant WebFetch calls via If-None-Match/If-Modified-Since HTTP revalidation.
---
...
- Symlink traversal protection is implemented to ensure the cache target cannot be manipulated or abused.
