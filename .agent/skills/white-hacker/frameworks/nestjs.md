---
name: white-hacker-nestjs
description: Security testing playbook for NestJS applications covering guards, pipes,
  decorators, module boundaries, and multi-transport auth
inputs: []
outputs: []
mcp_tools_required: []
subagent_triggers: []
