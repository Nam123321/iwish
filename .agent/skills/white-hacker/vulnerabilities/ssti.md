---
name: white-hacker-ssti
description: Server-side template injection across Jinja / Mako / Velocity / Freemarker
  / Thymeleaf / Twig / Handlebars / EJS / ERB with engine fingerprinting, sandbox
  escape, and RCE gadget chains
inputs: []
outputs: []
mcp_tools_required: []
subagent_triggers: []
