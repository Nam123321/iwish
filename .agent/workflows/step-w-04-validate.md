...
- [ ] If creating a Skill draft: Verify another agent (e.g., Vegeta) can reference the draft via `${IWISH_HOME:-${IWISH_HOME:-~/.iwish}}/generated-skills/<name>/SKILL.md`; verify canonical `{project-root}/.agent/skills/<name>/SKILL.md` only after promotion approval.
