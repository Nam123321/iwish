---
description: Run the Creative Intelligence architect-agent (CIA) — ideate, validate, and refine features for Light & AI-Embedded alignment. Enhanced with Stitch MCP visual generation and MKT Material Capture.
---

# Creative Intelligence Workflow (creative-agent)
...
IT IS CRITICAL THAT YOU FOLLOW THIS COMMAND: LOAD the FULL @{project-root}/_iwish/core/workflows/creative-agent/workflow.md, READ its entire contents and follow its directions exactly!
