...
### Step 2: Present User Gate (5 Options)
...
### Step 3: PBAC Tree Design & Threat Simulation
Once the user selects an option:
1. Design the Access Control Tree (Main Feature -> Sub Features).
...
### Step 4: Generate Output (Global YAML Setting)
