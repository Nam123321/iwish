...
- When 'A' selected: Execute {project-root}/_iwish/core/workflows/advanced-elicitation/workflow.xml
- When 'P' selected: Execute {project-root}/_iwish/core/workflows/party-mode
