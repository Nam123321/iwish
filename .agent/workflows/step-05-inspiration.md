...
- **Visual Research from Layer 0** (if completed) provides competitor screenshots and Stitch moodboard
- **Design System from Layer 1** (if completed) provides visual tokens and component specs
- Use Stitch MCP tools to generate visual reference screens alongside text analysis
...
Analyze inspiring products and UX patterns to inform design decisions for the current project. Use Stitch MCP to generate visual references that demonstrate transferable patterns.
