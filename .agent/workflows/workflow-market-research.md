---
legacy_name: market-research-legacy
...
4. Create the starter output file: `{planning_artifacts}/1. Idea Discovery/1.4. research/market-research.md` with exact copy of the `./research.template.md` contents
