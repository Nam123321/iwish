...
<steps CRITICAL="TRUE">
1. FOLLOW THE ABOVE COMMAND FIRST to draft the Architecture document.
2. CRITICAL — SOCRATIC REVIEW GATE 0. Before finalizing the Architecture, you MUST execute the Socratic Review Mode (Gate 0: `discovery`). Load `.agent/skills/socratic-review/SKILL.md` to stress-test the architectural decisions, tech stack justifications, and scalability assumptions.
</steps>
