...
DATA_BRIDGE_FILE = os.path.join(BMAD_OUTPUT_DIR, "navigator-data.js")
...
"""
    ...
    # Ensure BMAD_OUTPUT_DIR exists
    if not os.path.exists(BMAD_OUTPUT_DIR):
        os.makedirs(BMAD_OUTPUT_DIR)
