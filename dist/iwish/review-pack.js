...
exports.generateReviewPack = generateReviewPack;
...
function defaultCoreUseCases(input) {
    return [
...
function defaultAdjacentUseCases(input) {
    return [
...
function defaultDoNotUseCases(input) {
    return [
...
function defaultEdgeCases(input) {
    return [
...
function defaultStressCases(input) {
    return [
...
function defaultOrchHints(input) {
    return [
...
function defaultReviewQuestions(input) {
    return [
...
function defaultExamples(input) {
    return [
...
function buildMarkdown(input, slug) {
...
async function generateReviewPack(input) {
